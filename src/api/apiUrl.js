...
export const searchMovieUrl = (movieName) => `${url}/search/movie${api_key}&language=en-US&page=1&query=${movieName}`
...
export const deleteSessionUrl = () => `${url}/authentication/session${api_key}`
...
export const deleteListUrl = (listID, sessionID) => `${url}/list/${listID}${api_key}&session_id=${sessionID}`